...
| 3 | **Y must be measurable** with direction and ideally magnitude | *"...articles per session will increase by 10–15% in this cohort"* | *"...engagement will go up"* |
...
| 5 | **Must have 3+ distinct because-clauses** | Five clauses, each separately testable | One conflated clause |
| 6 | **Because-clauses must be falsifiable** | *"...cool subscribers will engage with personalised content at rates similar to warm subscribers"* | *"...because it would be better"* |
